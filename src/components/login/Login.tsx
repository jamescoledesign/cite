...
import { displayModal, deletedKeysModal } from "../modal/Modal";
// @ts-ignore
...
useEffect(() => {
  ...
  <div id="login" className={styles.login}>
      ...
      <input value={userId} name="userId" id="uid-field" className={styles.field} type="text" placeholder="Enter your Zotero User ID" />

      <label htmlFor="API Key">API Key</label>
      <div className={styles.pwField}>
          <input value={apiKey} name="apiKey" id="apikey-field" className={styles.field} type={inputType} placeholder="Enter your Zotero API key" />
      ...
      <div className="button-group">
        <button type="submit" id="submit-cred">Save keys</button>
        <button type="button" onClick={deleteKeys} id="submit-cred" className="secondary">Delete keys</button>
      </div>
